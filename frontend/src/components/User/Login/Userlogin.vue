      ...
      <div class="berry_login">
        ...
        <div class="berry_login_forms">
          ...
          <div class="berry_form_user">
            ...
            <button class="btn_user_login" @click="clickLogin">LOGIN</button>
          </div>
...
export default {
  ...
  setup() {
    ...
    function user_login() {
      ...
      // store.dispatch('requestLogin', state.user);
    }
    ...
    const clickLogin = () => {
      store.dispatch('login', { email: state.user.id, pw: state.user.password })
    }
    return { state, user_login, ocultar_login_user_company, clickLogin}
  },
}
</script>
